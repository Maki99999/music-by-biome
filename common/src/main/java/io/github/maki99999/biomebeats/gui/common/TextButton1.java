...
public class TextButton1 extends Button1 {
    public TextButton1(Component name, Component tooltip, Rect bounds, OnPress onPress) {
    ...
    protected void render(GuiGraphics guiGraphics, Point mousePos, float deltaTime) {
        ...
        drawScrollingString(guiGraphics, Minecraft.getInstance().font, getName(), innerBounds, 0, BiomeBeatsColor.WHITE.getHex(), true);
    }
}